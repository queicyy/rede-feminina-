...
const FormSinaisSintomasColoUtero: React.FC = () => {
  ...
  const handleChangeDias = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    // Apta se tiver 8 ou mais dias após a menstruação
    if (dias >= 8) setError((prev) => ({ ...prev, error_dias: false }))
    else setError((prev) => ({ ...prev, error_dias: true }))
  }
  ...
  const handleSubmit = (e: any) => {
    ...
    if (Object.values(error).some((value) => value === true)) {
      ...
      setMessage(
        'Você está apta a realizar o exame! Não se esqueça de trazer seus documentos: Identidade, CPF e o Cartão do SUS.'
      )
      setMessageError('')
    }
  }
            ...
            <form onSubmit={handleSubmit}>
                  ...
                  <WrapperOption>
                    ...
                    <Option>
                      <input
                        ...
                        value='nao'
                        onChange={() => {
                          setDataSubmit({ ...dataSubmit, relacao_sexual: 'nao' })
              ...
              {dataSubmit.relacao_sexual === 'nao' && (
                <Question>
                  <Column>
                    <WarningError>
                      Desculpe, o exame preventivo de colo de útero anual é recomendado a partir do momento que você tiver relações sexuais.
                    </WarningError>
                  </Column>
                </Question>
              )}
                    ...
                    <WrapperOption>
                      ...
                      <Option>
                        <input
                          ...
                          value='nao'
                          onChange={() => {
                            setDataSubmit({ ...dataSubmit, responsavel: 'nao' })
              ...
              {dataSubmit.responsavel === 'nao' && (
                <Question>
                  <WarningError>
                    <Column>Desculpe, é necessário estar acompanhada do responsável para realizar o exame.</Column>
                  </WarningError>
                </Question>
              )}
                  ...
                  <WrapperOption>
                    <Option>
                      <input
                        ...
                        value='sim'
                        onChange={() => {
                          setDataSubmit({ ...dataSubmit, pomada: 'sim' })
              ...
              {dataSubmit.dias > 0 && dataSubmit.dias < 8 && (
                <Question>
                  <WarningError>
                    <Column>Desculpe, o exame deve ser realizado pelo menos 8 dias após o último dia da menstruação.</Column>
                  </WarningError>
                </Question>
              )}
                  ...
                  <WrapperOption>
                    <Option>
                      <input
                        ...
                        required={true}
                      />
                      <label htmlFor='relacao_dias_sim'> Sim</label>
                    </Option>
                    <Option>
                      <input
                        type='radio'
                        ...
                        value='nao'
                        onChange={() => {
                          setDataSubmit({ ...dataSubmit, relacao_dias: 'nao' })
